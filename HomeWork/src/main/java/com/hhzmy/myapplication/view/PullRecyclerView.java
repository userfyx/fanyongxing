package com.hhzmy.myapplication.view;

import android.content.Context;
import android.support.v7.widget.RecyclerView;
import android.util.AttributeSet;

import com.hhzmy.myapplication.RecyclerViewClickListener;
...
public class PullRecyclerView extends PullBaseView<RecyclerView> {
    ...
    public void addOnItemTouchListener(RecyclerViewClickListener listener){
